...
TEST(AssemblerUnitTest, VarDeclWithNumberLiteralBuildsProgramTree)
{
...
TEST(AssemblerClassTest, EmptyClassDeclBuildsClassDeclStmt)
{
...
TEST(AssemblerClassTest, ClassInstantiationBuildsCallExpr)
{
...
TEST(AssemblerClassTest, FieldGetBuildsGetExpr)
{
...
TEST(AssemblerClassTest, FieldSetBuildsSetExpr)
{
...
TEST(ExecutorClassTest, MainTCPrintsFieldValue)
{
...
TEST(ExecutorClassTest, FieldUpdatePrintsUpdatedValue)
{
	std::string result = runCode(
		"Class Robot { } "
		"var r = Robot(); "
...
TEST(ExecutorClassTest, UndefinedFieldGetThrowsRuntimeError)
{
	try
	{
		runCode(
...
TEST(AssemblerClassTest, ClassWithMethodBuildsMethodInClassDecl)
{
...
TEST(AssemblerClassTest, ThisFieldAccessBuildsGetExprWithThisExpr)
{
...
TEST(ExecutorClassTest, MethodCallMovesPositionAndPrints)
{
	std::string result = runCode(
		"Class Robot { "
...
TEST(ExecutorClassTest, InitConstructorInitializesFields)
{
	std::string result = runCode(
		"Class Robot { "
...
TEST(ExecutorClassTest, NoInitWithArgsThrowsRuntimeError)
{
	try
	{
...
TEST(ExecutorClassTest, UndefinedMethodThrowsRuntimeError)
{
	try
	{
...
TEST(ExecutorClassTest, MethodInheritanceChildInstanceCallsParentMethod)
{
	std::string result = runCode(
		"Class Robot { "
...
TEST(ExecutorClassTest, MethodOverridingWithSuperCallPrintsParentThenChildMessage)
{
	std::string result = runCode(
		"Class Robot { "
		"  move(dist) { print \"move\"; } "
...
TEST(ExecutorClassTest, InstanceOfTrueForOwnClassAndAncestor)
{
	std::string result = runCode(
		"Class Robot { "
...
TEST(ExecutorClassTest, InstanceOfFalseForUnrelatedClass)
{
	std::string result = runCode(
		"Class Robot { } "
		"Class Toaster { } "
...
TEST(ExecutorClassTest, ThisOutsideClassThrowsRuntimeError)
{
	try
	{
		runCode("print This;");
...
TEST(ExecutorClassTest, ReturnValueInInitThrowsRuntimeError)
{
	try
	{
...
TEST(ExecutorClassTest, BareReturnInInitIsAllowed)
{
	std::string result = runCode(
		"Class Robot { "
...
TEST(ExecutorClassTest, ReturnFromOrdinaryMethodReturnsValue)
{
	std::string result = runCode(
		"Class Robot { "
		"  getFive() { return 5; } "
...
TEST(CheckerClassTest, SelfInheritanceReportsError)
{
...
TEST(CheckerClassTest, MutualInheritanceReportsCircularError)
{
...
TEST(CheckerClassTest, SuperOutsideClassReportsError)
{
...
TEST(CheckerClassTest, SuperWithoutParentReportsError)
{
...
TEST(CheckerClassTest, SuperWithParentIsAllowed)
{
	Program program = Assembler().assemble(
		"Class Robot { move(dist) { print \"move\"; } } "
...
TEST(ExecutorClassTest, InheritFromNonClassThrowsRuntimeError)
{
	try
	{
...
TEST(ExecutorClassTest, SuperOutsideClassThrowsRuntimeError)
{
	try
	{
		runCode("Super.move();");
...
TEST(ExecutorClassTest, SuperWithoutParentThrowsRuntimeError)
{
	try
	{
		runCode(
...
TEST(ExecutorClassTest, FieldAccessOnNonInstanceThrowsRuntimeError)
{
	try
	{
...
TEST(ExecutorClassTest, CallNonExistentMethodThrowsRuntimeError)
{
	try
	{
